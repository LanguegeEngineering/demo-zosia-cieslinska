...
Original file is located at
    https://colab.research.google.com/drive/1ISAfI-qvOBAsCddzZYV2PQyUuyLfKEBH
...
bool(re.search(r'raab', "Boabab"))
#print(re.search(r'raab', "Boabab"))
...
wzor = r'(.*)kota.' #nawiaskami zapamiętuje for later use
zamiennik = r"\1 psa." # wstawia, co tamten zapamiętał na danym miejscu

re.sub(wzor, zamiennik, zdanie) #sprawdza, czy wzór pasuje do zdania i zamienia na zamiennik
